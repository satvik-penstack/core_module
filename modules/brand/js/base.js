const masterBtn = document.getElementsByClassName('master-btn')[0];
const dashboardBtn = document.getElementsByClassName('dashboard-btn')[0];
const salesReportBtn = document.getElementsByClassName('report-sales-btn')[0];
const distributorManagementBtn = document.getElementsByClassName('master-distributor-btn')[0];
const ItemManagementBtn = document.getElementsByClassName('master-item-btn')[0];
const customerManagementBtn = document.getElementsByClassName('master-customer-btn')[0];
const master = document.getElementsByClassName('master')[0];
const sidebarBtnMap = new Map(Object.entries({
    '/brands/dashboard': dashboardBtn,
    '/reports/sales':  salesReportBtn,
}));
const sidebarOptionsMap = new Map(Object.entries({
    '/management/distributor': [masterBtn, distributorManagementBtn, master],
    '/management/item':[masterBtn, ItemManagementBtn, master],
    '/item/mapper': [masterBtn, ItemManagementBtn, master],
    '/management/customer': [masterBtn, customerManagementBtn, master],
}));
masterBtn.addEventListener("click", () => {
    if(master.style.display === "none" || master.style.display === "") {
...
if(sidebarBtnMap.has(path)){
    sidebarBtnMap.get(path).classList.add('sidebar-btn-active');
}
if(sidebarOptionsMap.has(path)){
    const [parentBtn, childBtn, container] = sidebarOptionsMap.get(path);
    container.style.display = "flex";
    parentBtn.classList.add('sidebar-btn-active');
    childBtn.classList.add('sidebar-btn-active');
}
